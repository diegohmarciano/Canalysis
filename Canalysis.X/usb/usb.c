...
/* USB Interrupt handler for PIC32MX
   Using IPL4SOFT for USB - can be adjusted for performance */
void __attribute__((vector(_USB_1_VECTOR), interrupt(IPL4SOFT), nomips16)) _USB1Interrupt(void)
{
	usb_service();
}
